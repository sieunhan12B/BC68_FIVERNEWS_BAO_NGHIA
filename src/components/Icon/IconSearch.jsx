...
const IconSearch = ({ size = 25, color = "black" }) => {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M11.412 8.586c.379.38.588.882.588 1.414h2a3.98 3.98 0 0 0-1.174-2.828c-1.514-1.512-4.139-1.512-5.652 0l1.412 1.416c.76-.758 2.07-.756 2.826-.002"
      />
    </svg>
  );
};
